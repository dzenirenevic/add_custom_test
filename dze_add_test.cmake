...
# Additionally test will be added to a target ${PROJECT_NAME}-run-tests if it exists.
# This allows running all tests with updated dependencies at once during the build stage.
function(dze_add_test)
    set(options "")
    ...
    if (ARG_NAME STREQUAL "")
        message(FATAL_ERROR "dze_add_test called without argument for name")
    endif ()
    ...
    if (TARGET ${PROJECT_NAME}-run-tests)
        add_dependencies(${PROJECT_NAME}-run-tests ${PROJECT_NAME}-run-test-${name})
    endif ()
endfunction()
